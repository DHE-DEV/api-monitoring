...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // API Monitor Routes
    Route::middleware('can:view-monitors')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware('can:view-groups')->group(function () {
            ...
            Route::delete('/groups/{group}/members/{user}', [GroupController::class, 'removeMember'])
                ...
                ->middleware('can:manage-groups');
            Route::post('/groups/{group}/monitors', [GroupController::class, 'addMonitor'])
                ->name('groups.add-monitor')
                ->middleware('can:manage-groups');
            Route::delete('/groups/{group}/monitors/{monitor}', [GroupController::class, 'removeMonitor'])
                ->name('groups.remove-monitor')
                ->middleware('can:manage-groups');
        });
    });
});
